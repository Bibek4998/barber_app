      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            BarberTutorialBox(text: 'Barbering Tools'),
            SizedBox(height: 16),
            BarberTutorialBox(text: 'Basic Hair Cuts'),
            SizedBox(height: 16),
            BarberTutorialBox(text: 'Hair Styling Techniques'),
            SizedBox(height: 16),
            BarberTutorialBox(text: 'Basics of Makeup and Makeup Tools'),
          ],
        ),
      ),
    );
